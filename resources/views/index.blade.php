...
<body>
  <!-- Navbar -->
  <nav class="navbar navbar-expand-md fixed-top navbar-light" style="background: #307F33;">
    <div class="container"> <a class="navbar-brand" href="#"><img src="assets/app/logo_beebagi.png" class=" center-block img-fluid d-block shadowed" width="30%"></a>
      ...
      <div class="collapse navbar-collapse text-center justify-content-end" id="navbar2SupportedContent">
        ...
        <!-- <a class="btn navbar-btn text-white mx-2 btn-primary" href="#download" >Download</a> -->
      </div>
    </div>
  </nav>
  <!-- Cover -->
  <div class="pt-5 bg-primary">
    ...
    <!--  <div class="row mt-5" >
          <div class="col-6 col-lg-5"> <a href="#">
              <img class="centC:\xampp\htdocser-block img-fluid d-block shadowed" src="assets/app/download_android.png"> </a> </div>
          <div class="col-6 col-lg-5"> <a href="#">
              <img class="center-block img-fluid d-block shadowed" src="assets/app/download_ios.png"> </a> </div> -->
  </div> --&gt; <div class="col-md-6">
    <!--<img class="img-fluid d-block mx-auto" src="assets/app/iphone_cover_light.png" width="400" > -->
  </div>
  <!-- Article style section -->
  <div class="py-5" style="background: #D2EC36;">
    <div class="container">
      <div class="row py-5">
        <div class="col-md-5 order-2 order-md-1"> <img class="img-fluid d-block my-3 mx-auto animate-in-left" src="assets/app/login.png" width="1000"> </div>
        <div class="col-md-7 align-self-center order-1 order-md-2 my-3 text-md-left text-center" style="background: rgba(253, 251, 251, 0.29); border-radius: 30px;">
          <div class="card-body" style="">
            ...
            <form class="">
              <div class="form-group"> <label>Email address</label> <input type="email" class="form-control" placeholder="Enter email" style="background: rgba(231, 229, 229, 0.24)">
                <!-- <small class="form-text text-muted" >We'll never share your email with anyone else.</small> -->
              </div>
              <div class="form-group"> <label>Password</label> <input type="password" class="form-control" placeholder="Password" style="background: rgba(231, 229, 229, 0.24)"> </div> <button type="submit" class="btn btn-primary btn-block" style="background: rgba(28, 75, 30, 0.33);">Submit</button><br>
              <center><small class="form-text text-muted">Forget Password</small></center> <br>
              <center><small class="form-text text-muted">Don’t have account ? <font color="#191847">Sing Up</font></small>
              </center><small class="form-text text-muted">
              </small>
            </form>
